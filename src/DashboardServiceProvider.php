<?php namespace Bluschool\Dashboard;
...
class DashboardServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->addConfigComponent('bluschool/dashboard', 'bluschool/dashboard', $path.'/resources/config');
        $this->addLanguageComponent('bluschool/dashboard', 'bluschool/dashboard', $path.'/resources/lang');
        $this->addViewComponent('bluschool/dashboard', 'bluschool/dashboard', $path.'/resources/views');
    ...
    {
        $this->app['events']->listen('orchestra.ready: admin', 'Bluschool\Dashboard\Http\Handlers\DashboardMenuHandler');
    }
    ...
    {
        $this->app['orchestra.extension.config']->map('bluschool/dashboard', [
